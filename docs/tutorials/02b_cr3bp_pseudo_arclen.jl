# # CR3BP: Pseudo-arclength continuation for planar Lyapunov families
#
# This tutorial demonstrates **pseudo-arclength continuation (PALC)** for a family
# of planar Lyapunov-like periodic orbits in the CR3BP using the `Motion.Continuation` module.
#
# We will:
#
...
# 3. Warm-start two points with **natural parameter** steps,
# 4. Continue the family using **pseudo-arclength** steps,
# 5. Plot the resulting orbit family.
#
...
push!(history, Continuation.step!(nat, history; ds = 0)[1])
popfirst!(history);
