...
"""
    make_cr3bp(μ, x0, t0, tf) -> EnsembleProblem
...
"""
    solve_cr3bp(μ, x0, t0, tf, [alg...]; kwargs...) -> BatchSolution
...
function solve_cr3bp(
    ...
    ens_sol = solve(prob, args..., EnsembleThreads(); trajectories = M, kwargs...)
    ...
    return BatchSolution(ens_sol, t0, tf, x0, xf)
end